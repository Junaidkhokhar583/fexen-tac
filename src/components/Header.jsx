            ...
            <nav className="bg-[#117e9f] flex items-center justify-around w-full z-50 py-2">
                ...
                <ul className="hidden md:flex md:gap-x-4">
                    <li className="font-medium font-sans">
                        <a href="#" className="group inline-block text-[#49c7ff]">
                            Home
                    ...
                    <li className="font-medium font-sans">
                        <a href="#" className="group text-[#49c7ff]">About
                    ...
                    <li className="font-medium font-sans">
                        <a href="#" className="group text-[#49c7ff]">Products
                            <span className="block group-hover:scale-x-100 scale-x-0 transition-transform duration-200 h-0.5 rounded-2xl bg-[#7e84ff] origin-left"></span>
                        </a>
                    </li>
                ...
                <button className="md:block hidden bg-[#5fabff] text-yellow-300 rounded-2xl p-2 hover:text-black hover:bg-white transition duration-300 cursor-pointer">Learn More</button>
                <button
                    onClick={() => setOpen(prev=>!prev)}
                    className="flex flex-col justify-center items-center md:hidden gap-1 w-7 h-7 bg-white rounded-lg z-50"
                >
                    <span
                        className={`block h-0.5 w-5 bg-black transition-transform duration-300 ${open ? "rotate-45 translate-y-1.5" : ""
                            }`}
                    ></span>

                    <span
                        className={`block h-0.5 w-5 bg-black transition-all duration-300 ${open ? "opacity-0" : ""
                            }`}
                    ></span>
